    ...
    <div class="wrapper">
        <header>
            <div class="log-header">
                <a href="<c:url value='/indexlog.do' />">
                    <img class="logo" src="${pageContext.request.contextPath}/resources/static/img/로고.png" alt="">
                </a>
                <ul>
        ...
        <section class="update">
            <h1>내 정보를 수정 해보세요!</h1>
            <form action="${pageContext.request.contextPath}/member/doUpdate.do" method="post">
                <c:if test="${empty updatedDto}">
                    <span class="title">ID</span><hr/>
                    <input type="text" name="id" value="${userDto.id}" readonly /><br />
                    <span class="title">NAME</span><hr/>
                    <input type="text" name="name" value="${userDto.name}" /><br />
                    <span class="title">PW</span><hr/>
                    <input type="password" name="pw" value="${userDto.pw}" /><br />
                    <span class="title">ADDR</span><hr/>
                    <input type="text" name="addr" value="${userDto.addr}" /><br />
                    <span class="title">PHONE</span><hr/>
                    <input type="text" name="phone" value="${userDto.phone}" />
                    <input id="update_btn" type="submit" value="수정하기" />
                </c:if>
                <c:if test="${not empty updatedDto}">
                    <span class="title">ID</span><hr/>
                    <input type="text" name="id" value="${updatedDto.id}" readonly /><br />
                    <span class="title">NAME</span><hr/>
                    <input type="text" name="name" value="${updatedDto.name}" /><br />
                    <span class="title">PW</span><hr/>
                    <input type="password" name="pw" value="${updatedDto.pw}" /><br />
                    <span class="title">ADDR</span><hr/>
                    <input type="text" name="addr" value="${updatedDto.addr}" /><br />
                    <span class="title">PHONE</span><hr/>
                    <input type="text" name="phone" value="${updatedDto.phone}" />
                    <input id="update_btn" type="submit" value="수정하기" />
                </c:if>
            </form>
